...
## ⚠️ Avertissement
Ce projet est à but éducatif uniquement. Les modèles développés ici ne doivent pas être utilisés en contexte clinique sans validation médicale rigoureuse.
...
> Licence : Creative Commons CC0 1.0 – Domaine Public
...
> Licence : CC BY-NC 4.0 (Creative Commons Attribution-NonCommercial 4.0 International License)
...
├── CNN_diagnostic_pneumonie.ipynb # Notebook principal
├── data/ # Données d'entraînement/test
├── img/ # Graphiques et résultats visuels
...
- Place les images dans `data/train/`, `data/val/`, `data/test/`
- Chaque dossier doit contenir `NORMAL/` et `PNEUMONIA/`

Ouvrir l'un des trois jupyter notebook:
...
> Suivre les information qui sont dans les **markdown**
...
**⚠️ voir la partie Modèles utilisés et mentions légales**